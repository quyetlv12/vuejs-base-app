...
const model = ref([
    ...
    },
    {
        label: 'Người dùng',
        items: [
            { label: 'Tài khoản', icon: 'pi pi-fw pi-user', to: '/auth/user', permission: 'users-list' },
            { label: 'Phân quyền', icon: 'pi pi-fw pi-check-square', to: '/auth/roles', permission: 'role-list' }
        ]
    }
    // {
    //     label: 'UI Components',
